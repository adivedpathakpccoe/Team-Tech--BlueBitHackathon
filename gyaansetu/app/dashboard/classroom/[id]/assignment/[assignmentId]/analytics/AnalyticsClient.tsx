...
export default function AnalyticsClient({ classroomId, assignmentId, token }: AnalyticsClientProps) {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            const aRes = await assignmentsApi.list(classroomId, token)
            if (aRes.data) {
            ...
            // Fetch submissions
            const sRes = await submissionsApi.listByAssignment(assignmentId, token)
            if (sRes.data) {
